...
\subsubsection*{LEDs for high speed applications (over 100 Mbps) | Mar-Apr 2013}

\emph{Guide: Prof Joseph John, Dept. of Electrical Engineering, IIT Bombay} \\*
  
\noindent $\bullet$ Presented a seminar on how LEDÕs could be used for high speed fiber optic communications. \\*
$\bullet$ LEDÕs are cheaper, rugged and safer to handle compared to laser diodes.
