...
\textbf{Languages}: C, Matlab, Python, bash scripting, Assembly for the Intel 8080 microprocessor, Octave, Verilog, Ruby, SQL, XML.\\*
...
\textbf{LEDs for high speed applications (over 100 Mbps) | Mar-Apr 2013} \\*
\emph{Guide: Prof Joseph John, Dept. of Electrical Engineering, IIT Bombay} \\*
$\bullet$ Presented a seminar on how LEDÕs could be used for high speed fiber optic communications. \\*
